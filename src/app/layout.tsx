  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Nexus AI – Smart AR Shopping Platform</title>
        <meta name="description" content="Nexus AI is an AI-powered Smart AR Shopping Platform integrating IoT, AI, and Augmented Reality to transform enterprise retail — incubated at NIT Patna." />
